...
<body>
    ...
    <img src="{{ $message->embed(public_path('images/NIB-logo.png')) }}" alt="NIB Logo" width="150px">
   ...
   <strong>For Info:</strong> info@notioninsurance.com<br>
   <strong>For POSP:</strong> pospsupport@notioninsurance.com</p>
</body>
</html>
 --}}
...
<body>
    <div class="container">
        ...
        <strong>Call:</strong> +0755-4911343 , +919302182475 <br>
        <strong>Address:</strong> Plot No. 1, 3rd Floor, Lalwani Complex, Vidya Nagar, Bhopal - 462026.<br>
        <strong>Email for Info:</strong> <a href="mailto:contactus@notioninsurance.com">contactus@notioninsurance.com</a><br>
        </p>
